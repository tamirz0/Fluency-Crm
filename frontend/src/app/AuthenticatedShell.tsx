...
function NavigationContent({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return <Box sx={{ display: 'flex', height: '100%', flexDirection: 'column' }}>
    ...
    <List sx={{ px: 1.5, py: 2 }} aria-label="Navegación principal">
      <ListItemButton component={NavLink} to="/inicio" end onClick={onNavigate} sx={{ position: 'relative', mb: .5, borderRadius: 1, color: 'text.secondary', '&.active': { color: 'primary.main', bgcolor: 'rgba(98,189,181,.12)', '&::before': { content: '""', position: 'absolute', left: 0, top: 8, bottom: 8, width: 3, bgcolor: 'primary.main' } }, '&:hover': { bgcolor: 'rgba(231,239,241,.06)' } }}><ListItemIcon sx={{ minWidth: 38, color: 'inherit' }}><Dashboard fontSize="small" /></ListItemIcon><ListItemText primary="Inicio" /></ListItemButton>
      <ListItemButton component={NavLink} to="/empresas" onClick={onNavigate} sx={{ mb: .5, borderRadius: 1, color: 'text.secondary', '&.active': { color: 'primary.main', bgcolor: 'rgba(98,189,181,.12)' } }}><ListItemIcon sx={{ minWidth: 38, color: 'inherit' }}><Business fontSize="small" /></ListItemIcon><ListItemText primary="Empresas" /></ListItemButton>
      <ListItemButton component={NavLink} to="/contactos" onClick={onNavigate} sx={{ mb: .5, borderRadius: 1, color: 'text.secondary', '&.active': { color: 'primary.main', bgcolor: 'rgba(98,189,181,.12)' } }}><ListItemIcon sx={{ minWidth: 38, color: 'inherit' }}><Contacts fontSize="small" /></ListItemIcon><ListItemText primary="Contactos" /></ListItemButton>
      <ListItemButton component={NavLink} to="/oportunidades" onClick={onNavigate} sx={{ mb: .5, borderRadius: 1, color: 'text.secondary', '&.active': { color: 'primary.main', bgcolor: 'rgba(98,189,181,.12)' } }}><ListItemIcon sx={{ minWidth: 38, color: 'inherit' }}><Timeline fontSize="small" /></ListItemIcon><ListItemText primary="Oportunidades" /></ListItemButton>
      <ListItemButton component={NavLink} to="/embudo" onClick={onNavigate} sx={{ mb: .5, borderRadius: 1, color: 'text.secondary', '&.active': { color: 'primary.main', bgcolor: 'rgba(98,189,181,.12)' } }}><ListItemIcon sx={{ minWidth: 38, color: 'inherit' }}><ViewKanban fontSize="small" /></ListItemIcon><ListItemText primary="Embudo" /></ListItemButton>
    </List>
